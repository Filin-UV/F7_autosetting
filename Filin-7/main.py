...
#         print(frame2.max())
        ...
        if self.current_mode ==  2:
            if record_video:
                frame1 = cv2.putText(frame1, 'Rec~', (30, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2, cv2.LINE_AA)
            ...
            if record_video:
                frame2 = cv2.putText(frame2, 'Rec~', (30, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2, cv2.LINE_AA)
...
#                 self.histo_l.opacity = 100
            ...
            if record_video:
                frame3 = cv2.putText(frame3, 'Rec~', (30, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2, cv2.LINE_AA)
